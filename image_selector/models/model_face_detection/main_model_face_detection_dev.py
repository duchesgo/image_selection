...
def face_detecting(master_dic, cascade_path, scaleFactor, minNeighbors, minSize, visualize=False):
    ...
    detected_faces=master_dic
    image=detected_faces["image_array"]
