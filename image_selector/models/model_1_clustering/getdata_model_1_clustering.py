...
def img_to_ndarray(path):
    """The function returns a list of ndarray images from the path of a folder containing the images."""
...
def bmp_to_ndarray(path, img):
    """The function returns a ndarray image from a .bmp image."""
...
def jpg_to_ndarray(path, img):
    """The function returns a ndarray image from a .jpg image."""
