...
def scoring_chunk(dataset="SPAC",data_status="processed",start=1,finish=8):
    ...
    for index in range(len(X_list)):
        ...
        master_dic=face_detecting_DeepFace(image_dict=master_dic, cascade_path=cascade_path_tp, scaleFactor=scaleFactor_tp, minNeighbors=minNeighbors_tp, minSize=minSize_tp, visualize=False,min_face_surface_in_image=surface_visage_min_in_image)
...
def sorting_rules_pipeline(dataset="TYPOLOGIE_CLUSTER"):
    ...
    transfering_raw_image(dataset=dataset,dict_of_target=master_dict,start=1,finish=60)
...
if __name__=="__main__":
    ...
    sorting_rules_pipeline(dataset="TYPOLOGIE_CLUSTER")
